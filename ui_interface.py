...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.set_correction_toolButton = QtWidgets.QToolButton(self.centralwidget)
        self.set_correction_toolButton.setEnabled(False)
        self.set_correction_toolButton.setAutoFillBackground(False)
        self.set_correction_toolButton.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/feather-version-1-1/svg/icons8-edit.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.set_correction_toolButton.setIcon(icon1)
        self.set_correction_toolButton.setObjectName("set_correction_toolButton")
        self.verticalLayout_3.addWidget(self.set_correction_toolButton, 0, QtCore.Qt.AlignTop)
...
"border: 1px solid #999999;")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/feather-version-1-1/svg/inbox-434350.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gather_load.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/feather-version-1-1/png-48/trash-48x48-434411.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.gather_del.setIcon(icon3)
...
"}")
        ...
        self.travel_times_load.setIcon(icon2)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/feather-version-1-1/svg/trash-434411.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.travel_times_del.setIcon(icon4)
...
"}")
        ...
        self.source_coords_load.setIcon(icon2)
        ...
        self.source_coords_del.setIcon(icon4)
...
"border: 1px solid #999999;")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/feather-version-1-1/svg/square-434399.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.select_alltoolButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/feather-version-1-1/svg/stop-434405.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.unselect_alltoolButton.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/feather-version-1-1/svg/repeat-434386.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.update_tensor_moments_pushButton.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/feather-version-1-1/svg/marquee-434366.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_row_pushButton.setIcon(icon8)
        ...
        self.delete_row_pushButton.setIcon(icon4)
        ...
        self.upload_pushButton.setIcon(icon2)
        ...
        self.horizontalSlider.valueChanged['int'].connect(self.detect_function_spinBox.setValue) # type: ignore
        self.detect_function_spinBox.valueChanged['int'].connect(self.horizontalSlider.setValue) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Emission Tomography"))
        MainWindow.setStatusTip(_translate("MainWindow", "Version 0.3"))
        self.set_correction_toolButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Set correction for selected travel times</p></body></html>"))
